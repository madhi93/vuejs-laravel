        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li> <!-- recordings --> <a href="QA.php"> <i class="menu-icon fa fa-question"></i> Question & Answer </a> </li><li> <!-- Email --> <a href="invoice.php"> <i class="menu-icon fa fa-mail-forward"></i>Send Invoice mail </a> </li>
                    <li>
