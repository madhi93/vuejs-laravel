...
<div class="row col-lg-12 " >
    <form action="categories.php" method="POST">
                  ...
                  <button type="submit" class="btn btn-info btn-sm rounded bg-dark text-warning" style="margin-bottom: 10px;margin-top: 10px;"><h1>Skilled</h1></button>
                </form>
                <form action="categories_unskilled.php" method="POST">

                  <button type="submit" class="btn btn-info btn-sm rounded bg-dark text-warning" style="margin-bottom: 10px;margin-top: 10px; margin-left:10px;"><h1>UnSkilled</h1></button>
                </form>
      ...
      var doc =document.getElementById(d).value; 
       var st="status"+id;
        var val = document.getElementById(st).checked;
            ...
            xmlhttp.open("POST", "un_skilled_a.php?statusa="+ val+"&token="+doc, true); 
            xmlhttp.send();
        }
      ...
      var doc =document.getElementById(d).value; 
       var st="status"+id;
        var val = document.getElementById(st).checked;
            ...
            xmlhttp.open("POST", "un_skilled_d.php?statusd="+ val+"&token="+doc, true); 
            xmlhttp.send();
        }
      ...
      var doc =document.getElementById(d).value; 
       var st="status"+id;
        var val = document.getElementById(st).checked;
            ...
            xmlhttp.open("POST", "un_skilled_m.php?statusm="+ val+"&token="+doc, true); 
            xmlhttp.send();
        }
      ...
      var doc =document.getElementById(d).value; 
       var st="status"+id; 
        ...
        var val = document.getElementById(st).checked;
            ...
            xmlhttp.open("POST","un_skilled_f.php?statusf="+ val+"&token="+doc, true);
            xmlhttp.send();
        }
</script>
...
<div class="col-lg-12 " align="center">
                  ...
                  <button  class="btn btn-info btn-sm rounded bg-dark text-light" style="margin-bottom: 10px;margin-top: 10px;"><h1>UnSkilled</h1></button>
          </div>
<div class="card-body">
    <?php
              $city = $database->collection("categories")->document("un_skilled")->collection("0");
                ...
                <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <div class="dropdown-menu-content">
                                <form action="un_category_edit_fill.php" method="POST">
                              <input type="hidden" name="ref_skilled_edit" value="<?php echo $document->id() ?>">
                               ...
                               <form action="un_category_delete.php" method="POST">
...
<?php
    $doc = $document->id();
    $data =$database->collection("categories")->document("un_skilled")->collection("0")->document("$doc")->snapshot()->data();
    $a= "hi";
...
?>
   <div class="col-lg-12 " align="center">
                  ...
                  <button type="text" class="btn btn-info btn-sm rounded bg-dark text-info" style="margin-bottom: 10px;margin-top: 10px;" data-toggle="modal" data-target="#mediumModal"><h2>Add Category</h2></button>
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-lg-12">
                                    <form action="un_category_add.php" method="POST">
                    <div class="card">
