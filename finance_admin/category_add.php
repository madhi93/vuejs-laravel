...
if(isset($_POST['category_add'])){
   ...
   $datas =$database->collection("categories")->document("skilled")->collection("0")->add($data);
...
if(isset($_POST['update_category'])){
   ...
   $datas =$database->collection("categories")->document("skilled")->collection("0")->document("$to")->update($data);
