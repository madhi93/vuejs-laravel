...
<?php
   $token=$_GET['token']; 
   $docRef = $database->collection('Services')->document('business')->collection('business_services')->document($token);
                    ...
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                          ...
                          <button type="submit" class="btn btn-primary btn-sm" name="businessUpdate">
