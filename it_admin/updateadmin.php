...
<?php
   $token=$_GET['token']; 
   $docRef = $database->collection('cancelled_services')->document('Admin')->collection('admin')->document($token);
                    ...
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                          ...
                          <button type="submit" class="btn btn-primary btn-sm" name="adminUpdate">
